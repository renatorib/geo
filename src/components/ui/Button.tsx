...
export const variants = /* tw */ {
  filled: {
    root: "text-context-50 bg-context-700 hover:bg-context-800 hover:white active:bg-context-900",
  },
  light: {
    root: "text-context-800 bg-context-200 hover:bg-context-300 hover:text-context-900 active:bg-context-400",
  },
  outline: {
    root: "text-context-800 border-context-300 hover:border-context-400 hover:text-context-900 active:border-context-600",
  },
  ghost: {
    root: "text-context-800 bg-transparent hover:bg-context-200 active:bg-context-300",
  },
  muted: {
  ...
  link: {
    root: "text-context-800 bg-transparent hover:text-context-900 hover:underline active:text-context-950",
  },
  none: {
    root: "",
  },
